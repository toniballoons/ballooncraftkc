      ...
      {value ? (
        <div className="relative group rounded-xl overflow-hidden border bg-muted">
          ...
          <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
            <label className="cursor-pointer bg-white text-black text-xs font-semibold px-3 py-2 rounded-lg flex items-center gap-1.5 hover:bg-gray-100 transition-colors">
              <Upload className="w-3.5 h-3.5" /> Replace
              <input type="file" accept="image/*" className="hidden" onChange={handleFile} disabled={uploading} ref={inputRef} />
            </label>
        ...
        <label className="cursor-pointer flex flex-col items-center justify-center border-2 border-dashed border-border rounded-xl p-8 bg-muted/40 hover:bg-muted/70 transition-colors">

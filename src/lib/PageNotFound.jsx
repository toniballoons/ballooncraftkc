            ...
            <div className="max-w-md w-full">
                <div className="text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-8xl font-display text-primary/30">404</h1>
                        <div className="flex justify-center gap-2">
                            {['bg-pink-400','bg-yellow-400','bg-blue-400'].map((c,i) => (
                                <div key={i} className={`${c} w-4 h-5 rounded-full opacity-50`} style={{borderRadius:'50% 50% 50% 50% / 40% 40% 60% 60%'}} />
                            ))}
                        </div>
                    </div>
